...
namespace LocalStorage.Data.Migrations
{
    ...
    [Migration("20190509024502_user added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalStorage.Models.TestFormModel", b =>
                {
                    b.Property<int>("Int")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("SposeMiddleName");
            ...
            modelBuilder.Entity("LocalStorage.Models.UserMasterModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LocalStorage.Models.UserPhoneDetailModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("UserMasterModelId");

                    b.HasKey("Id");

                    b.HasIndex("UserMasterModelId");

                    b.ToTable("UserPhoneDetail");
                });
            ...
            modelBuilder.Entity("LocalStorage.Models.UserPhoneDetailModel", b =>
                {
                    b.HasOne("LocalStorage.Models.UserMasterModel", "UserMasterModel")
                        .WithMany("UserPhoneDetails")
                        .HasForeignKey("UserMasterModelId")
